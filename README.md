Chúng ta sẽ thực hiện face recognition trong ảnh và video với OpenCV, Python và Deep Learning. Trong bài này chúng ta sử dụng 2 thư viện là `dlib` và `face_recognition`.
